...
app.post('/', async (req, res) => {
  try {
    ...
    const response = await openai.createCompletion({
      ...
      prompt: `answer asked question acting as technical support engineer called "ishimwe" working for microfocus. you sound as professional techinical support engineer. question: ${prompt}`,
      temperature: 0, // Higher values means the model will take more risks.
      max_tokens: 3000, // The maximum number of tokens to generate in the completion. Most models have a context length of 2048 tokens (except for the newest models, which support 4096).
      top_p: 4, // alternative to sampling with temperature, called nucleus sampling
